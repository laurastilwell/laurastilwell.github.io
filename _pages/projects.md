...
<h4>Cash as Housing Support: The Causal Impact of an Uncondtional Cash Transfer on Housing and Neighborhood Conditions of Low-Income, U.S. Children </h4>
...
**Abstract:** A long-standing debate in housing policy centers on whether direct cash transfers can achieve the goals of housing assistance programs while avoiding unintended consequences such as reductions in employment and earnings, landlord discrimination, and rent inflation in response to vouchers. To inform this debate, we examine the causal impact of a monthly unconditional cash transfer on housing and neighborhood conditions among families with low-income and young children—a key population of policy importance for housing assistance programs—using data from a randomized controlled trial called Baby’s First Years, in which 1,000 mothers received either $333 (“high-cash gift”; n=400) or $20 (“low-cash gift”, n=600) for the first 76 months of their child’s life. We find that the cash gift reduced housing cost burdens and increased consumption of non-housing goods, with no detectable impacts on neighborhood characteristics, rent levels, or employment and earnings. The cash gift also impacted other dimensions of housing: families were less likely to live in multigenerational households and less likely to move within the child’s first three years. Reported housing assistance receipt declined over the first three years, a pattern that appears to reflect household choices rather than changes in income eligibility.
...
This project is being implemented by the [Centre for Economic Research in Pakistan (CERP)](https://www.cerp.org.pk/) and has been funded by USAID DIV, [The Weiss Fund](https://bfi.uchicago.edu/the-weiss-fund/), and the [Fund for Innovation in Development (FID)](https://fundinnovation.dev/en/projects/supporting-breastfeeding-in-pakistan-through-a-mobile-application). 
